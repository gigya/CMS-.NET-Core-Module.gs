...
{
    public abstract class GigyaSettingsHelper : GigyaSettingsHelper<GigyaModuleSettings>
    {
    ...
    public abstract class GigyaSettingsHelper<T> : IGigyaSettingsHelper<T> where T: class, IGigyaModuleSettings, new()
    {
