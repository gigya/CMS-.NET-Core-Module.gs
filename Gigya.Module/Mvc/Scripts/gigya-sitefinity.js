...
var gigyaSitefinity = {
    ...
    onProfileUpdated: function (eventObj) {
        ...
        qwest.post(gigyaSitefinity.baseUrl + 'editprofile', data)
    ...
    login: function (eventObj, redirectAfterLogin) {
        ...
        qwest.post(gigyaSitefinity.baseUrl + 'login', data)
         .then(function (xhr, response) {
    ...
    logout: function (redirectAfterLogout) {
        var data = { Id: gigyaSitefinity.id };

        qwest.post(gigyaSitefinity.baseUrl + gigyaSitefinity.logoutApiAction, data)
         .then(function (xhr, response) {
             if (response != null && response.status == gigyaSitefinity.responseCodes.Success) {
