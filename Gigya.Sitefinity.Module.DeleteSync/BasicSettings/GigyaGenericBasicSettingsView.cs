...
namespace Gigya.Sitefinity.Module.DeleteSync.BasicSettings
{
    ...
    {
        public static readonly string layoutTemplateName = ModuleClass.ModuleVirtualPath + "Gigya.Sitefinity.Module.DeleteSync.BasicSettings.GigyaGenericBasicSettingsView.ascx";
        ...
        protected override void InitializeControls(Control viewContainer)
        {
            ...
            this.FieldsBinder.ServiceUrl = string.Format("~/Sitefinity/CustomServices/GigyaDeleteSyncSettings.svc/generic/?itemType={0}", (object)HttpUtility.UrlEncode(this.DataContract.FullName));
