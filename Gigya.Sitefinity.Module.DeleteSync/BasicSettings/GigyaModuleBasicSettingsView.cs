...
namespace Gigya.Sitefinity.Module.DeleteSync.BasicSettings
{
    public class GigyaModuleBasicSettingsView : SimpleView
    {
        ...
        internal readonly static string layoutTemplatePath = ModuleClass.ModuleVirtualPath + "Gigya.Sitefinity.Module.DeleteSync.BasicSettings.GigyaModuleSettingsView.ascx";
