...
namespace Gigya.Sitefinity.Module.DeleteSync
{
    ...
    public class ModuleClass : ModuleBase
    {
        ...
        public override void Initialize(ModuleSettings settings)
        {
            ...
            App.WorkWith()
                .Module(settings.Name)
                    ...
                    //.Configuration<DeleteSyncSettings>()
                    .BasicSettings<GigyaGenericBasicSettingsView<GigyaModuleBasicSettingsView, GigyaModuleSettingsContract>>
                        ("GigyaDeleteSync", "Gigya Delete Sync", "", typeof(GigyaModuleSettingsContract), false);
        ...
        public const string AssemblyName = "Gigya.Sitefinity.Module.DeleteSync";
        public const string ModuleName = "Gigya Delete Sync";
        internal const string ModuleTitle = "Gigya Delete Sync";
        internal const string ModuleDescription = "This is a Custom Module which has been built to delete users from Sitefinity when requested by Gigya.";
        internal const string ModuleVirtualPath = "~/GigyaDeleteSync/";
        internal const string WidgetSectionName = "GigyaDeleteSync";
        #endregion
    }
}