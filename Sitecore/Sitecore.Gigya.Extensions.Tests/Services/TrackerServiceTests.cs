...
namespace Sitecore.Gigya.Extensions.Tests.Services
{
    public class TrackerServiceTests
    {
        ...
        [Theory]
        [AutoDbData]
        public void FacetUpdate_ShouldUpdatePersonalFacet([NoAutoProperties] TrackerService trackerService, ITracker tracker, [Substitute] Session session)
        {
            // arrange
            ...
            var mappingFields = new List<MappingFieldGroup>
            {
                ...
                {
                    FacetName = Sitecore.Gigya.Extensions.Abstractions.Analytics.Constants.FacetKeys.PersonalFacetKey,
            ...
            using (new TrackerSwitcher(tracker))
            {
                ...
                {
                    trackerService.UpdateFacets(gigyaModel, mappingFields);
                }
                ...
                var facet = contact.GetFacet<IContactPersonalInfo>(Sitecore.Gigya.Extensions.Abstractions.Analytics.Constants.FacetKeys.PersonalFacetKey);
