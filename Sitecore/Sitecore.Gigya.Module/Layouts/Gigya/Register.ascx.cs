...
namespace Sitecore.Gigya.Module.Layouts.Gigya
{
    public partial class Register : System.Web.UI.UserControl
    {
        ...
        private Models.GigyaRegisterViewModel Model()
        {
            ...
            var renderingModel = _renderingPropertiesRepository.Get<GigyaRegisterRenderingModel>(Attributes["sc_parameters"]);
            ...
            var model = new GigyaRegisterViewModel
            {
                ...
                LoggedInUrl = new ExtendedLinkUrl().GetUrl(renderingModel.LoggedInUrl, Sitecore.Context.Database)
            };
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            loggedinurl.Value = model.LoggedInUrl;
        }
    }
}