...
(function(n){"function"==typeof define&&define.amd?define(n):window.onDomReady=n()})(function(){function e(t){if(!f){if(!n.body)return u(e);for(f=!0;t=nt.shift();)u(t)}}function t(t){(l||t.type===o||n[p]===y)&&(a(),e())}function a(){l?(n[g](k,t,r),i[g](o,t,r)):(n[b](d,t),i[b](v,t))}function u(n,t){setTimeout(n,+t>=0?t:1)}function h(n){f?u(n):nt.push(n)}var i=window,n=i.document,tt=n.documentElement,o="load",r=!1,v="on"+o,y="complete",p="readyState",w="attachEvent",b="detachEvent",c="addEventListener",k="DOMContentLoaded",d="onreadystatechange",g="removeEventListener",l=c in n,s=r,f=r,nt=[];if(n[p]===y)u(e);else if(l)n[c](k,t,r),i[c](o,t,r);else{n[w](d,t);i[w](v,t);try{s=null==i.frameElement&&tt}catch(rt){}s&&s.doScroll&&function it(){if(!f){try{s.doScroll("left")}catch(n){return u(it,50)}a();e()}}()}return h.version="1.4.0",h.isReady=function(){return f},h});var gigyaCms={responseCodes:{Error:0,Success:1,AlreadyLoggedIn:2,LogoutIfNoLoginFired:3},loginSource:{Login:0,GetAccountInfo:1},loggingInClassName:"gigya-cms-logging-in",authenticated:!1,authenticatedOnServerByCurrentPage:!1,baseUrl:"/api/gigya/account/",debugMode:!1,log:function(n,t){gigyaCms.debugMode&&window.console&&(t?console.log(n,t):console.log(n))},handleError:function(n){n&&n.length>0?alert(n):alert(gigyaCms.genericErrorMessage)},redirectAfterLogin:function(n){gigyaCms.redirectAfterEvent(n,gigyaCms.loggedInRedirectUrl)},redirectAfterRegister:function(n){var t=gigyaCms.registeredAndLoggedInRedirectUrl;t||(t=gigyaCms.loggedInRedirectUrl);gigyaCms.redirectAfterEvent(n,t)},redirectAfterEvent:function(n,t){t&&(n=t);n&&n.length>0?window.location=n:window.location.reload()},redirectAfterEditProfile:function(){},redirectAfterLogout:function(n){gigyaCms.redirectAfterEvent(n,gigyaCms.logoutRedirectUrl)},genericErrorMessage:"Sorry an error occurred. Please try again.",id:"",loggedInRedirectUrl:"",registeredAndLoggedInRedirectUrl:"",logoutRedirectUrl:"",logoutApiAction:"logout",screenSetSettings:{login:{screenSet:"Default-RegistrationLogin"},register:{screenSet:"Default-RegistrationLogin",startScreen:"gigya-register-screen"},editProfile:{screenSet:"Default-ProfileUpdate",onAfterSubmit:function(n){gigyaCms.onProfileUpdated(n)}}},initGetAccountInfo:function(){gigya.accounts.getAccountInfo({callback:gigyaCms.onGetAccountInfo})},attachEvents:function(n,t,i){for(var r=0;r<n.length;r++)n[r].addEventListener(t,i,!1)},applyConfig:function(){gigya.accounts.addEventHandlers({onLogin:gigyaCms.onLogin,onLogout:gigyaCms.onLogout});window.gigyaConfig.errorMessage&&window.gigyaConfig.errorMessage.length>0&&(gigyaCms.genericErrorMessage=window.gigyaConfig.errorMessage);gigyaCms.id=window.gigyaConfig.id;gigyaCms.loggedInRedirectUrl=window.gigyaConfig.loggedInRedirectUrl;gigyaCms.logoutRedirectUrl=window.gigyaConfig.logoutRedirectUrl;gigyaCms.debugMode=window.gigyaConfig.debugMode;window.gigyaConfig.logoutApiAction&&(gigyaCms.logoutApiAction=window.gigyaConfig.logoutApiAction);window.gigyaBaseUrl&&(gigyaCms.baseUrl=window.gigyaBaseUrl)},showScreenSet:function(n,t){var i=t.target,s=n.screenSet,f=i.getAttribute("data-gigya-screen"),e,r,o,u;f&&(n.screenSet=f);e=n.mobileScreenSet;r=i.getAttribute("data-gigya-mobile-screen");r&&(n.mobileScreenSet=r);o=n.startScreen;u=i.getAttribute("data-gigya-start-screen");u&&(n.startScreen=u);gigyaCms.log("screen set settings",n);gigya.accounts.showScreenSet(n);n.screenSet=s;n.mobileScreenSet=e;n.startScreen=o},initialized:!1,init:function(){var t,i,r,n;if(gigyaCms.initialized){gigyaCms.log("gigyaCms already initialized...ignoring");return}for(gigyaCms.attachEvents(document.getElementsByClassName("gigya-cms-login"),"click",function(n){return gigyaCms.showScreenSet(gigyaCms.screenSetSettings.login,n),n.preventDefault(),!1}),gigyaCms.attachEvents(document.getElementsByClassName("gigya-cms-logout"),"click",function(n){return gigya.accounts.logout({callback:gigyaCms.onLogoutTriggeredByUser}),n.preventDefault(),!1}),gigyaCms.attachEvents(document.getElementsByClassName("gigya-cms-register"),"click",function(n){return gigyaCms.showScreenSet(gigyaCms.screenSetSettings.register,n),n.preventDefault(),!1}),gigyaCms.attachEvents(document.getElementsByClassName("gigya-cms-edit-profile"),"click",function(n){return gigyaCms.showScreenSet(gigyaCms.screenSetSettings.editProfile,n),n.preventDefault(),!1}),gigyaCms.initEmbeddedScreens(),t=document.getElementsByClassName("gigya-cms-logged-in-url"),n=0;n<t.length;n++)if(t[n].value){gigyaCms.loggedInRedirectUrl=t[n].value;break}for(i=document.getElementsByClassName("gigya-cms-registered-logged-in-url"),n=0;n<i.length;n++)if(i[n].value){gigyaCms.registeredAndLoggedInRedirectUrl=i[n].value;break}for(r=document.getElementsByClassName("gigya-cms-logged-out-url"),n=0;n<r.length;n++)if(r[n].value){gigyaCms.logoutRedirectUrl=r[n].value;break}gigyaCms.initialized=!0},initEmbeddedScreens:function(){for(var n,t,r=document.getElementsByClassName("gigya-cms-embedded-screen"),i=0;i<r.length;i++)if(n=r[i],t={containerID:n.getAttribute("data-gigya-container-id"),screenSet:n.getAttribute("data-gigya-screen"),mobileScreenSet:n.getAttribute("data-gigya-mobile-screen"),startScreen:n.getAttribute("data-gigya-start-screen")},n.getAttribute("data-update-profile")&&(t.onAfterSubmit=gigyaCms.onProfileUpdated),gigyaCms.log("applying embedded screen with settings",t),gigya.accounts.showScreenSet(t),!document.getElementById(t.containerID))throw new Error("Unable to find container with id of "+t.containerID);},onGetAccountInfo:function(n){gigyaCms.log("onGetAccountInfo",n);n.errorCode==0?gigyaCms.login(n,!1,gigyaCms.loginSource.GetAccountInfo):gigyaCms.logout(!1)},onProfileUpdated:function(n){if(gigyaCms.log("onProfileUpdated",n),n.response&&n.response.UID){var t={UserId:n.response.UID,Signature:n.response.UIDSignature,SignatureTimestamp:n.response.signatureTimestamp,Id:gigyaCms.id};qwest.post(gigyaCms.baseUrl+"editprofile",t).then(function(n,t){t!=null&&t.status==gigyaCms.responseCodes.Success?gigyaCms.redirectAfterEditProfile(t.redirectUrl):gigyaCms.handleError(t.errorMessage)})["catch"](function(){gigyaCms.handleError()})}},onLogin:function(n){gigyaCms.loginEventFired=!0;gigyaCms.log("onLogin",n);gigyaCms.login(n,!0,gigyaCms.loginSource.Login)},loginEventFired:!1,loggingIn:!1,login:function(n,t,i){gigyaCms.loggingIn=!0;var u={UserId:n.UID,Signature:n.UIDSignature,SignatureTimestamp:n.signatureTimestamp,Id:gigyaCms.id,LoginSource:i},r=document.getElementsByTagName("body")[0];i!=gigyaCms.loginSource.Login||r.classList.contains(gigyaCms.loggingInClassName)||r.classList.add(gigyaCms.loggingInClassName);qwest.post(gigyaCms.baseUrl+"login",u).then(function(i,u){if(gigyaCms.loggingIn=!1,u!=null)switch(u.status){case gigyaCms.responseCodes.AlreadyLoggedIn:gigyaCms.authenticated=!0;t===!0&&gigyaCms.authenticatedOnServerByCurrentPage||gigyaCms.loginEventFired?gigyaCms.redirectAfterLogin(u.redirectUrl):r.classList.remove(gigyaCms.loggingInClassName);return;case gigyaCms.responseCodes.LogoutIfNoLoginFired:gigyaCms.loginEventFired||(gigya.accounts.logout(),r.classList.remove(gigyaCms.loggingInClassName));return;case gigyaCms.responseCodes.Success:if(gigyaCms.authenticated=!0,gigyaCms.authenticatedOnServerByCurrentPage=!0,window.gigyaConfig.enableSSOToken){var f={redirectURL:u.redirectUrl};gigya.accounts.setSSOToken(f)}else t===!0||gigyaCms.loginEventFired?n.newUser?gigyaCms.redirectAfterRegister(u.redirectUrl):gigyaCms.redirectAfterLogin(u.redirectUrl):r.classList.remove(gigyaCms.loggingInClassName);return;case gigyaCms.responseCodes.Error:gigyaCms.log("logout");gigya.accounts.logout();gigyaCms.handleError(u.errorMessage);r.classList.remove(gigyaCms.loggingInClassName);return}else gigyaCms.log("logout"),gigya.accounts.logout(),gigyaCms.handleError(u.errorMessage),r.classList.remove(gigyaCms.loggingInClassName)})["catch"](function(n,t,i){if(gigyaCms.loggingIn=!1,t.status==0){gigyaCms.log("login request aborted...skipping");r.classList.remove(gigyaCms.loggingInClassName);return}var u={e:n,xhr:t,response:i};gigyaCms.log("login error",u);gigya.accounts.logout();t.status===500&&gigyaCms.handleError();r.classList.remove(gigyaCms.loggingInClassName)})},onLogoutTriggeredByUser:function(){gigyaCms.log("onLogout triggered by user");gigyaCms.logout(!0)},onLogout:function(n){gigyaCms.log("onLogout",n);gigyaCms.logout(!1)},logout:function(n){var t={Id:gigyaCms.id,Force:n};qwest.post(gigyaCms.baseUrl+gigyaCms.logoutApiAction,t).then(function(t,i){if(i!=null)switch(i.status){case gigyaCms.responseCodes.Success:n&&gigyaCms.redirectAfterLogout(i.redirectUrl)}else gigyaCms.handleError(i.errorMessage)})["catch"](function(n,t){t.status===500&&gigyaCms.handleError()})}};gigyaCms.applyConfig();(!window.gigyaConfig||window.gigyaConfig.getInfoRequired)&&gigyaCms.initGetAccountInfo();onDomReady(function(){gigyaCms.init()});