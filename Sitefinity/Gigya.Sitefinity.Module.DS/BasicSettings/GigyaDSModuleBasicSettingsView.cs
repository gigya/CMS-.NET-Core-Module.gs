...
{
    public class GigyaDSModuleBasicSettingsView : SimpleView
    {
        // The virtual path to your ascx file
        internal readonly static string layoutTemplatePath = ModuleClass.ModuleVirtualPath + "Gigya.Sitefinity.Module.DS.BasicSettings.GigyaDSModuleSettingsView.ascx";
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if(string.IsNullOrEmpty(base.LayoutTemplatePath))
                {
                    ...
                    return GigyaDSModuleBasicSettingsView.layoutTemplatePath;
                }
